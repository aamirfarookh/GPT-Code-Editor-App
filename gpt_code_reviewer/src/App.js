...
function App() {
  ...
  async function convertCode(){
    try {
      ...
      let req = await fetch(`https://code-reviewer-5vb3.onrender.com/api/convert`,{
        method:"POST",
        headers:{
  ...
  async function debugCode(){
    ...
    try {
      let req = await fetch(`https://code-reviewer-5vb3.onrender.com/api/debug`,{
        method:"POST",
        headers:{
          "Content-Type":"application/json"
        },
  ...
  async function checkCodeQuality(){
    ...
    try {
      ...
      let req = await fetch(`https://code-reviewer-5vb3.onrender.com/api/qualityCheck`,{
        method:"POST",
        headers:{
          "Content-Type":"application/json"
        },
  ...
  async function executeCode(){
    try {
      ...
      let req = await fetch(`https://code-reviewer-5vb3.onrender.com/api/execute`,{
        method:"POST",
        headers:{
          "Content-Type":"application/json"
        },
